...
public class MusicPreference extends CheckBoxPreference {
    ...
    public static String TAG = "MusicPreference";
    ...
    public MusicPreference(final Context context, final AttributeSet attrst) {
        super(context, attrst);
        CONTEXT = context;
        SYSFS_PATH = context.getString(R.string.music_sysfs_file);
        ENABLED_VALUE = context.getString(R.string.music_enabled_value);
        DISABLED_VALUE = context.getString(R.string.music_disabled_value);
    }
    ...
    public static void restore(Context context) {
        ...
        String value = (settings.getBoolean("music_gesture", false) ? ENABLED_VALUE : DISABLED_VALUE);
    ...
    public Boolean checkSupport() {
        SYSFS_PATH = getContext().getString(R.string.music_sysfs_file);
