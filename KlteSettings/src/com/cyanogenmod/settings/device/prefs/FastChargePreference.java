 ...
 */
public class FastChargePreference extends CheckBoxPreference {

    public static String TAG = "FastChargePreference";
    ...
    public FastChargePreference(final Context context, final AttributeSet attrst) {
        super(context, attrst);
        CONTEXT = context;
        SYSFS_PATH = context.getString(R.string.fastcharge_sysfs_file);
        ENABLED_VALUE = context.getString(R.string.fastcharge_enabled_value);
        DISABLED_VALUE = context.getString(R.string.fastcharge_disabled_value);
    }
    ...
    public static void restore(Context context) {
        ...
        String value = (settings.getBoolean("fast_charge", false) ? ENABLED_VALUE : DISABLED_VALUE);
    ...
    public Boolean checkSupport() {
        SYSFS_PATH = getContext().getString(R.string.fastcharge_sysfs_file);
