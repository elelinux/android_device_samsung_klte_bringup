 ...
 */
public class TorchPreference extends CheckBoxPreference {

    public static String TAG = "TorchPreference";
    ...
    public TorchPreference(final Context context, final AttributeSet attrst) {
        super(context, attrst);
        CONTEXT = context;
        SYSFS_PATH = context.getString(R.string.flashlight_sysfs_file);
        ENABLED_VALUE = context.getString(R.string.flashlight_enabled_value);
        DISABLED_VALUE = context.getString(R.string.flashlight_disabled_value);
    }
    ...
    public static void restore(Context context) {
        ...
        String value = (settings.getBoolean("torch_gesture", false) ? ENABLED_VALUE : DISABLED_VALUE);
    ...
    public Boolean checkSupport() {
        SYSFS_PATH = getContext().getString(R.string.flashlight_sysfs_file);
