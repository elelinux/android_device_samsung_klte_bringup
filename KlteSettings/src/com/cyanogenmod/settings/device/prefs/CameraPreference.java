 ...
 */
public class CameraPreference extends CheckBoxPreference {

    public static String TAG = "CameraPreference";
    ...
    public CameraPreference(final Context context, final AttributeSet attrst) {
        super(context, attrst);
        CONTEXT = context;
        SYSFS_PATH = context.getString(R.string.camera_sysfs_file);
        ENABLED_VALUE = context.getString(R.string.camera_enabled_value);
        DISABLED_VALUE = context.getString(R.string.camera_disabled_value);
    }
    ...
    public static void restore(Context context) {
        ...
        String value = (settings.getBoolean("camera_gesture", false) ? ENABLED_VALUE : DISABLED_VALUE);
    ...
    public Boolean checkSupport() {
        SYSFS_PATH = getContext().getString(R.string.camera_sysfs_file);
